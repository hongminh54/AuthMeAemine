...
public interface DataSource extends Reloadable {
     ...
     * @return Usernames associated with the given IP addresses
     */
    List<String> getAllAuthsByIp(String ip);

    /**
     * Clear the last IP address for a specific user.
     *
     * @param user The username whose IP should be cleared
     * @return True upon success, false upon failure
     */
    boolean clearLastIp(String user);

    /**
     * Clear the last IP address for all users with the given IP.
     *
     * @param ip The IP address to clear from all accounts
     * @return Number of accounts updated
     */
    int clearLastIpForIp(String ip);

    /**
     * Clear all last IP addresses from the database.
     *
     * @return Number of accounts updated
     */
    int clearAllLastIp();
