...
public class VersionCommand implements ExecutableCommand {
    ...
    public void executeCommand(CommandSender sender, List<String> arguments) {
        ...
        sender.sendMessage(ChatColor.GOLD + "==========[ Thông tin về " + AuthMe.getPluginName() + "]==========");
        sender.sendMessage(ChatColor.GOLD + "Phiên bản: " + ChatColor.WHITE + AuthMe.getPluginName()
            + " v" + AuthMe.getPluginVersion() + ChatColor.GRAY + " (build: " + AuthMe.getPluginBuildNumber() + ")");
        sender.sendMessage(ChatColor.GOLD + "Tác giả:");
        ...
        printDeveloper(sender, "TYBZI", "TYBZI", "Developer, Rewrite Code", onlinePlayers);
        sender.sendMessage(ChatColor.GOLD + "Tác giả đã nghỉ hưu (Retired):");
        ...
        sender.sendMessage(ChatColor.GOLD + "Server: " + ChatColor.GREEN
            + "AEMINE.VN");
